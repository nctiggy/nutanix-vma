...
// handleSubnetList handles GET /api/networking/v4.0/config/subnets.
func (s *Server) handleSubnetList(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, paginatedResponse(subnets[skip:end], total))
}
